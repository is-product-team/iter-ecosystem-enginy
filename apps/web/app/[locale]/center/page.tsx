            ...
            {loadingPhases ? (
              ...
              phases.map((phase) => (
                ...
                >
                  {/* Square with number */}
                  <div
                    className={`w-12 h-12 flex items-center justify-center mb-6 z-10 border transition-all ${
                      phase.isActive
      ...
      <div className="flex justify-center w-full pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full">
          {[
            ...
            >
              <div
                className={`absolute top-0 right-0 w-16 h-16 bg-background-subtle -mr-8 -mt-8 rotate-45 transition-colors duration-300 ${
                  item.active ? 'group-hover:bg-consorci-darkBlue' : ''
                }`}
              ></div>

              <div
                className={`w-16 h-16 flex items-center justify-center mb-8 border border-border-subtle transition-all duration-300 ${
                  item.active
              ...
              <h3
                className={`text-xl font-medium mb-3 tracking-tight ${
                  item.active ? 'text-text-primary' : 'text-text-muted'
                }`}
              >
                {item.title}
              </h3>
              ...
              <div className="mt-8 flex items-center">
                <div
                  className={`flex items-center font-medium text-[11px] transition-transform ${
                    item.active
