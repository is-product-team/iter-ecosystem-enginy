            ...
            <div className="w-full pb-20 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="bg-white p-8 border shadow-sm flex flex-col items-center justify-center text-center">
                        <span className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-4">Experiència Alumnat</span>
                    ...
                    <div className="bg-white p-8 border shadow-sm flex flex-col items-center justify-center text-center">
                        <span className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-4">Satisfacció Docent</span>
                    ...
                    {/* Mocks para métricas adicionales */}
                    <div className="bg-white p-8 border shadow-sm flex flex-col items-center justify-center text-center">
                        <span className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-4">Tallers Completats</span>
                    ...
                    <div className="bg-white p-8 border shadow-sm flex flex-col items-center justify-center text-center">
                        <span className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-4">Part. Alumnat</span>
                        <span className="text-5xl font-black text-gray-900">1240</span>
                        <p className="text-[10px] font-black uppercase text-blue-600 mt-2">Inscripcions totals</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="bg-black text-white p-10 shadow-2xl flex flex-col">
                        <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-10">Top Tallers Valorats</h3>
                        <div className="space-y-8 flex-1">
                            {[
                                { name: 'Impressió 3D', score: 4.8 },
                                { name: 'Robòtica LEGO', score: 4.7 },
                                { name: 'Disseny Web', score: 4.5 },
                                { name: 'Electrònica', score: 4.3 }
                            ].map((t, i) => (
                        ...
                        <button className="mt-12 w-full py-4 bg-white text-black font-black uppercase text-[10px] tracking-widest hover:bg-blue-400 transition-all">Descarregar Resum PDF</button>
                    </div>
                </div>
                ...
                <div className="p-8 bg-red-50 border-2 border-red-600 shadow-[8px_8px_0px_0px_rgba(220,38,38,0.1)] flex gap-6 items-center">
                    ...
                    <div>
                        <h4 className="text-xs font-black uppercase tracking-widest text-red-700 mb-1">Alertes de Baixa Valoració</h4>
                        <p className="text-sm text-red-900/60 font-bold uppercase tracking-tighter italic">2 Tallers mostren una satisfacció inferior al 3.5. Es recomana revisió amb el centre referente.</p>
                    </div>
                    <button className="ml-auto bg-red-600 text-white px-6 py-3 text-[10px] font-black uppercase tracking-widest hover:bg-black transition-all shadow-lg">Veure Detalls</button>
                </div>
